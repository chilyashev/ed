...
$result = mysql_query("SELECT * FROM `news` WHERE body LIKE '%$search%' order by id desc");
echo "SELECT * FROM `news` WHERE body LIKE '%$search%' OR `name` LIKE '%$search%' order by id desc";
$inw = "Новини";
