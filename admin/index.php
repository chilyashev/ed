...
<?=getNewsTitles(6);?>
				...
				if(isset($_GET['w'])){
					switch($_GET['w']){
						default;
						?>
						<h2>&raquo;Добавяне на потребител</h2><br /><br />
						<a href="?do=add&amp;w=student" rel="tooltip" title="Добавяне на ученик"><?=getIcon("uchenik.png")?></a> <a href="?do=add&amp;w=teacher" rel="tooltip" title="Добавяне на учител"><?=getIcon("uchitel.png")?></a> <a href="?do=add&amp;w=parent"  rel="tooltip" title="Добавяне на родител"><?=getIcon("roditel.png")?></a><br /><br />
							<div id="help"><?=getIcon("q.png", 16)?>
							Изберете какъв потребител да добавите:<br />
							<?=getIcon("rodite.png", 16)?> - за родител<br />
							<?=getIcon("edit.png", 16)?> - за родител<br />
							<?=getIcon("edit.png", 16)?> - за родител<br />							
							</div>
<?
						break; //break default
				...
				include "addUser.php";
						...
						<h2>&raquo;Добавяне на потребител</h2><br /><br />
					<a href="?do=add&amp;w=student" rel="tooltip" title="Добавяне на ученик"><?=getIcon("uchenik.png")?></a> <a href="?do=add&amp;w=teacher" rel="tooltip" title="Добавяне на учител"><?=getIcon("uchitel.png")?></a> <a href="?do=add&amp;w=parent"  rel="tooltip" title="Добавяне на родител"><?=getIcon("roditel.png")?></a>
						<br /><br />
							<div id="help"><?=getIcon("q.png", 16)?>
							Изберете какъв потребител да добавите:<br />
							<?=getIcon("uchenik.png", 16)?> - за ученик<br />
							<?=getIcon("roditel.png", 16)?> - за родител<br />
							<?=getIcon("uchitel.png", 16)?> - за учител<br />							
							</div>
					<?
					}
				break; //add
...
loading ...&nbsp;</div>";
						...
						echo "<h2>&raquo;Предмети</h2><br />";
							...
							?><br /><br />
							<div id="help">
							<?=getIcon("q.png", 16)?>Тук можете да редактирате и триете предмети.<br />
							Кликнете <?=getIcon("edit.png", 16)?>, за да промените предмета или <?=getIcon("delete.png", 16)?>, за да го изтриете.
							</div>
...
?><br /><br />
							<div id="help"><?=getIcon("q.png", 16)?>
							Кликнете <?=getIcon("edit.png", 16)?>, за да промените класа или <?=getIcon("delete.png", 16)?>, за да го изтриете.
							</div>
<?
						break;
...
actadmlink('#teachers');</script>
					...
					?><br /><br />
							<div id="help"><?=getIcon("q.png", 16)?>
							Кликнете <?=getIcon("edit.png", 16)?>, за да промените учителя или <?=getIcon("delete.png", 16)?>, за да го изтриете.
							</div>
<?
						break;
...
?><br /><br />
							<div id="help"><?=getIcon("q.png", 16)?>
							Кликнете <?=getIcon("edit.png", 16)?>, за да промените ученика или <?=getIcon("delete.png", 16)?>, за да го изтриете.
							</div>
...
actadmlink('#parents');</script>
						...
						?><br /><br />
							<div id="help"><?=getIcon("q.png", 16)?>
						Кликнете <?=getIcon("edit.png", 16)?>, за да промените родителя или <?=getIcon("delete.png", 16)?>, за да го изтриете.<br />						За да одобрите родител, кликнете <?=getIcon("ok.png", 16)?>.<br />
						За да премахнете правото му да влиза, кликнете <?=getIcon("cancel.png", 16)?>
...
actadmlink('#novini');</script>
							...
							<div id="help"><?=getIcon("q.png", 16)?>
							Кликнете <?=getIcon("edit.png", 16)?>, за да промените новината или <?=getIcon("delete.png", 16)?>, за да я изтриете.
							</div>
		<?
					break;
...
actadmlink('#pages');</script>
					...
					?><br /><br />
							<div id="help"><?=getIcon("q.png", 16)?>
							Кликнете <?=getIcon("edit.png", 16)?>, за да промените страницата или <?=getIcon("delete.png", 16)?>, за да я изтриете.
							</div>
					<?
					break;
